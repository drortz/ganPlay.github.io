...
module.exports = ".appear-as-disable{\r\n  pointer-events: none;\r\n  opacity: 0.2;\r\n}\r\n\r\n.nextback{\r\n  width: 90px;\r\n  border-radius: 100%;\r\n  cursor: pointer;\r\n}\r\n\r\n.nextback:hover{\r\n  /* transform: scale(1.2); */\r\n  /* filter: blur(5px); */\r\n}\r\n\r\n.nextback:active{\r\n  /* filter: blur(5px); */\r\n  -webkit-transform: scale(1.3);\r\n          transform: scale(1.3);\r\n}\r\n\r\n@media screen and (max-width: 994px) {\r\n  .nextback{\r\n    width: 70px;\r\n  }\r\n}\r\n\r\n@media screen and (max-width: 760px) {\r\n  .nextback{\r\n    width: 45px;\r\n  }\r\n}\r\n\r\n.example-list {\r\n  width: 1000px;\r\n  max-width: 100%;\r\n  border: solid 1px #ccc;\r\n  min-height: 60px;\r\n  display: flex;\r\n  flex-direction: row;\r\n  background: white;\r\n  border-radius: 4px;\r\n  overflow: hidden;\r\n\r\n}\r\n\r\n.example-list-correct {\r\n  width: 1000px;\r\n  max-width: 100%;\r\n  border: solid 1px #ccc;\r\n  min-height: 60px;\r\n  display: flex;\r\n  flex-direction: row;\r\n  background: rgb(69, 255, 100);\r\n  border-radius: 4px;\r\n  overflow: hidden;\r\n\r\n}\r\n\r\n.example-list :hover{\r\n  background-color: cornflowerblue;\r\n}\r\n\r\n.example-box {\r\n  padding: 20px 10px;\r\n  border-right: solid 1px #ccc;\r\n  color: rgba(0, 0, 0, 0.87);\r\n  display: flex;\r\n  flex-direction: row;\r\n  align-items: center;\r\n  justify-content: space-between;\r\n  box-sizing: border-box;\r\n  cursor: move;\r\n  background: white;\r\n  font-size: 18px;\r\n  font-weight: bold;\r\n  flex-grow: 1;\r\n  flex-basis: 0;\r\n  justify-content: center;\r\n}\r\n\r\n.example-box-correct {\r\n  padding: 20px 10px;\r\n  border-right: solid 1px #ccc;\r\n  color: rgba(0, 0, 0, 0.87);\r\n  display: flex;\r\n  flex-direction: row;\r\n  align-items: center;\r\n  justify-content: space-between;\r\n  box-sizing: border-box;\r\n  cursor: move;\r\n  background: rgb(69, 255, 100);\r\n  font-size: 28px;\r\n  font-weight: bold;\r\n  flex-grow: 1;\r\n  flex-basis: 0;\r\n  justify-content: center;\r\n}\r\n\r\n.cdk-drag-preview {\r\n  box-sizing: border-box;\r\n  border-radius: 4px;\r\n  background-color: rgb(127, 168, 243);\r\n  box-shadow: 0 5px 5px -3px rgba(0, 0, 0, 0.2),\r\n              0 8px 10px 1px rgba(0, 0, 0, 0.14),\r\n              0 3px 14px 2px rgba(0, 0, 0, 0.12);\r\n\r\n}\r\n\r\n.cdk-drag-placeholder {\r\n  opacity: 0;\r\n}\r\n\r\n.cdk-drag-animating {\r\n  transition: -webkit-transform 250ms cubic-bezier(0, 0, 0.2, 1);\r\n  transition: transform 250ms cubic-bezier(0, 0, 0.2, 1);\r\n  transition: transform 250ms cubic-bezier(0, 0, 0.2, 1), -webkit-transform 250ms cubic-bezier(0, 0, 0.2, 1);\r\n}\r\n\r\n.example-box:last-child {\r\n  border: none;\r\n}\r\n\r\n.example-list.cdk-drop-list-dragging .example-box:not(.cdk-drag-placeholder) {\r\n  transition: -webkit-transform 250ms cubic-bezier(0, 0, 0.2, 1);\r\n  transition: transform 250ms cubic-bezier(0, 0, 0.2, 1);\r\n  transition: transform 250ms cubic-bezier(0, 0, 0.2, 1), -webkit-transform 250ms cubic-bezier(0, 0, 0.2, 1);\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var LettersComponent = /** @class */ (function () {
    function LettersComponent(dragDrop, router, answerFeedback, activeRoute) {
        ...
        this.dynamicPredicateFirstLetter = function (item) {
            if (item.element.nativeElement.textContent === _this.mockDataToDisplay.firstLetter) {
                _this.isFirstLetterCorrect = true;
                return true;
            }
            return false;
        };
        this.dynamicPredicateLastLetter = function (item) {
            if (item.element.nativeElement.textContent === _this.mockDataToDisplay.lastLetter) {
                _this.isLastLetterCorrect = true;
                return true;
            }
            return false;
        };
    ...
    LettersComponent.prototype.isCompletelyAnswered = function () {
        return this.isFirstLetterCorrect && this.isLastLetterCorrect;
    };
